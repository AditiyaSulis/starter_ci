...
<main>
	...
	<ul class="nav nav-tabs mt-8 ms-5">
		<li class="nav-item">
			<a class="nav-link text-dark border border-bottom-0 rounded-top bg-hover-light active" aria-current="page" href="<?=base_url('admin/Koperasi/koperasi_paid_page?status=1')?>">Paid</a>
		</li>
		<li class="nav-item">
			<a class="nav-link  text-info " href="<?=base_url('admin/Koperasi/koperasi_page?status=2')?>">Unpaid</a>
		</li>
	</ul>
