...
<main>
    ...
    <ul class="nav nav-tabs mt-8">
        <li class="nav-item">
            <a class="nav-link text-dark" aria-current="page" href="<?=base_url('admin/purchases/purchases_paid_page?status_purchases=1')?>">Paid</a>
        </li>
        <li class="nav-item">
            <a class="nav-link active text-info" href="<?=base_url('admin/purchases/purchases_unpaid_page?status_purchases=0')?>">Unpaid</a>
        </li>
    </ul>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="table-responsive">
						<table id="jatuhtempo_table" class="table table-bordered table-striped table-hover border-primary" style="width:100%">
							<thead>
							<tr>
								<th>No</th>
								<th>Tanggal Input</th>
								...
								<tr>
									...
									<td>
										<?php if($purchase['payment_type'] == 1):?>
											<span class="badge gradient-btn-debit btn-sm" style="width:50px">Debit</span>
										<?php else:?>
											<span class="badge gradient-btn-kredit btn-sm" style="width:50px">Kredit</span>
										<?php endif; ?>
									</td>
									<td><?= date('d F Y', strtotime($purchase['jatuh_tempo']))?></td>
									<td><?= $purchase['description']; ?></td>
									<td>
										<button class="btn gradient-btn-edit btn-sm mb-2 rounded-pill btn-pay"
												style="width: 70px"
										...
										<button class="btn gradient-btn-delete mb-2 btn-sm rounded-pill btn-delete-pc"
												data-id_purchases="<?= $purchase['id_purchases']; ?>"
												style="width: 70px">
											DELETE
										</button>
									</td>
