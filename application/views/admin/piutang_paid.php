<main>
    ...
    <ul class="nav nav-tabs mt-8">
        <li class="nav-item">
            <a class="nav-link active text-info" aria-current="page" href="<?=base_url('admin/piutang/piutang_paid_page')?>">Paid</a>
        </li>
        <li class="nav-item">
            <a class="nav-link text-dark" href="<?=base_url('admin/piutang/piutang_page')?>">Unpaid</a>
        </li>
    </ul>
    ...
    <script>
        ...
        function callDT() 
        {
            var table = $('#piutangpaid_table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: base_url + 'admin/piutang/dtSideServer_paid',  
                    type: 'POST',
                    data: function(d) {
