...
class M_payroll_component extends CI_Model
{
	...
	public function getPayrollComponentDataCore_get()
	{
		...
		$this->db->select('payroll_component.id_payroll_component, payroll_component.id_employee, payroll_component.total_absen, payroll_component.id_payroll, payroll_component.total, payroll_component.total_izin, payroll_component.total_cuti, payroll_component.total_overtime, payroll_component.total_dayoff, payroll_component.piutang, payroll_component.bonus,payroll_component.tanggal_gajian, payroll_component.potongan_absen,  payroll_component.potongan_izin, payroll_component.absen_hari, payroll_component.izin_hari,  payroll_component.total_potongan, payroll_component.description, payroll_component.periode_gajian, payroll_component.libur_nasional_hari, payroll_component.total_libur_nasional, payroll_component.potongan_libur_nasional, payroll_component.total_potongan_telat, payroll_component.potongan_cuti, payroll_component.cuti_hari, employee.name, employee.id_product, employee.id_division, employee.basic_salary, employee.nip,  employee.bonus, employee.uang_makan, products.name_product, division.name_division, position.name_position');
		if (!empty($payroll) ) {
